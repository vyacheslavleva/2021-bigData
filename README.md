...
# [2] Работа с данными по GoT (фийл \_lab-2\GoT\battles.csv)
...
1. Построить графики зависимости (как в абсолютных значениях, так и в нормированных, два графика) следующего:
	...
	d) считая, что каждая битва длилась в среднем 4 месяца, посчитать сколько в каждом году воевал каждый из королей (как нападавших, так и защищающихся). 
