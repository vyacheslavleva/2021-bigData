...
plt.gca().set_xticklabels(df2['Broad Bean Origin'].min(), rotation=50, horizontalalignment='center', fontsize=5)
...
plt.gca().set_xticklabels(df2['Broad Bean Origin'].max(), rotation=50, horizontalalignment='center', fontsize=5)
